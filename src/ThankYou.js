...
const ThankYou = () => {
  return (
    <div>
      <div class="flex items-center justify-center mb-52 mt-16">
        ...
        <div class="flex flex-col items-center p-4 space-y-2 bg-white">
          ...
          <p>Thank you for choosing DermCare for your healthcare needs. We appreciate your trust in our services and are committed to providing you with the best possible care. Your recent booking for a doctor's appointment with DermCare is important to us, and we look forward to ensuring you a seamless and positive experience.</p>
          <a
